...
export default function TiffinForgotPasswordPage() {
      ...
      <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleEmailSubmit}>
            <div className="rounded-md shadow-sm">
              ...
              <input
                ...
                className="mt-1 block w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-zinc-900 placeholder-zinc-400 focus:border-orange-500 focus:ring-orange-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 sm:text-sm"
          ...
          <form className="mt-8 space-y-6" onSubmit={handleOtpSubmit}>
            <div className="rounded-md shadow-sm">
              ...
              <input
                ...
                className="mt-1 block w-full rounded-xl border border-zinc-200 bg-white px-4 py-3 text-zinc-900 placeholder-zinc-400 focus:border-orange-500 focus:ring-orange-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 sm:text-sm tracking-widest text-center text-xl"
                placeholder="123456"
                maxLength={6}
              />
            </div>
        ...
        {step === 'success' && (
          <div className="mt-8 text-center space-y-4">
            ...
            <div>
              <Link href="/login" className="inline-block w-full rounded-xl bg-orange-500 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-orange-600">
                Return to Login
              </Link>
            </div>
          </div>
        ...
        {step !== 'success' && (
          <div className="text-center mt-4">
            <Link href="/login" className="text-sm font-medium text-zinc-600 hover:text-orange-500 dark:text-zinc-400">
